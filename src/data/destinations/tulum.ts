...
export const tulumPlaces: Place[] = [
  ...
  {
    id: 'pl-papaya-playa-project',
    name: 'Papaya Playa Project',
    country: 'Mexico',
    city: 'Tulum',
    category: 'beach',
    description: 'A sustainable beachfront venue on the Tulum coast — local music, art and cuisine, and the closest thing this stretch of beach has to a scene without losing its barefoot, bohemian core.',
    photos: [],
    isJetSetPick: false,
    priceLevel: '$$',
    tags: ['beach', 'live music', 'sustainable'],
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Papaya+Playa+Project+Tulum',
    sourceUrl: 'https://thebrunchmanifesto.blog/2025/11/17/tulum-beach-guide-bohemian-calm-and-caribbean-soul/',
  },
  {
